...
print('  PROGRAMA DE CONFIGURACION INICIAL DE PVControl+ para Hibridos tipo Voltronic/Axpert')
print(Fore.CYAN)
print(' Este programa realiza la configuracion de PVControl+ para Hibridos tipo Voltronic/Axpert')
print()
print (' Para un uso mas avanzado posteriormente edite y modifique el fichero Parametros_FV.py')
print (Fore.YELLOW)
print('#' * 90)
...
fichero3 ='/home/pi/PVControl+/Parametros_FV_HIBRIDO.py'
...
print()
print ( Fore.RESET + 'En esta version simplificada de configuracion de PVControl+ se ha establecido para un '+ Fore.GREEN+'HIBRIDO tipo Voltronic/Axpert')
print ( Fore.RESET + 'Si tiene algo incorrecto edite de nuevo el archivo Parametros_FV.py y cambie los valores')
print()
print(Fore.RED + ' Si modifica los valores de AH de bateria o de vis (48V, 24V o 12V) en el archivo Parametros_FV.py ejecute desde terminal....')
print()
print(Fore.CYAN + '     python3 PVControl_Configuracion_Web.py')
print()
print (Fore.RESET + ' Para reconfigurar la Web')
print()
print (Fore.YELLOW + '-' * 100)
print()
print(Fore.RED + ' Si modifica los valores del puerto, protocolo, usar CRC, etc reinicie el servicio hibrido....')
print()
print(Fore.CYAN + '     sudo systemctl restart hibrido')
