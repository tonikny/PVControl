...
class GestorParametrosDI:
    ...
    def __init__(self, logger: Optional[GestorLogsDI] = None, check_interval=5):
        ...
        self._log.debug("Gestor de Parámetros con inyección de dependencias inicializado con éxito")
