...
class GestorLogs:
    ...
    Compatible with multiprocessing environments.
    ...
    def __init__(self, nombre="pvcontrol", level=None):
        ...
        queue_handler = QueueHandler(GestorLogs._log_queue)
    ...
    def manual(self, *msg):
        ...
        if GestorLogs._main_logger:
            for handler in GestorLogs._main_logger.handlers:
...
atexit.register(GestorLogs.cleanup)