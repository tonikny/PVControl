...
como respaldo) usando cargador_parametros.
...
- Importación automática de configuración desde cargador_parametros
...
class GestorBD:
    ...
    def __init__(
        ...
        Args:
            servidor: Nombre del servidor o IP (por defecto: auto-importado de Parametros_FV.py)
            usuario: Usuario de base de datos (por defecto: auto-importado de Parametros_FV.py)
            clave: Contraseña de base de datos (por defecto: auto-importado de Parametros_FV.py)
            basedatos: Nombre de base de datos (por defecto: auto-importado de Parametros_FV.py)
        ...
        if not all([self.servidor, self.usuario, self.clave, self.nombre_bd]):
            raise ValueError(
                "Los parámetros de base de datos deben proporcionarse explícitamente o existir en Parametros_FV.py. "
