...
sensores ={
'Vbat'    : {"d_['GOODWE']['vbattery1']"},  # Sensor de Voltaje bateria
'Vplaca'  : {"d_['GOODWE']['vpv1']"},        # Sensor de Voltaje placa
 
'Ibat'    : {"-d_['GOODWE']['ibattery1']"}, # Sensor de Intensidad bateria
'Iplaca'  : {"d_['GOODWE']['ipv1']"},       # Sensor de Intensidad Placas

'Aux1'  : {"-d_['GOODWE']['pbattery1']"}, # Sensor Aux1
'Aux2'  : {"d_['GOODWE']['pback_up']"},    # Sensor Aux2
'Aux3'  : {"d_['GOODWE']['vbattery1']"},    # Sensor Aux3
'Aux4'  : {},    # Sensor Aux4
'Aux5'  : {},    # Sensor Aux5
'Aux6'  : {},    # Sensor Aux6
'Aux7'  : {},    # Sensor Aux7

'Vred' : {"d_['GOODWE']['vgrid']"},   # Sensor Voltaje de red 
'Ired' : {"d_['GOODWE']['igrid']"},   # Sensor Intensidad de red
'EFF'  : {"d_['GOODWE']['battery_soc']"},   # Eficienca Conversion 

'Temp_Bat': {},  #  Sensor Temperatura

# Expresiones calculadas
'Wbat' : {"-d_['GOODWE']['pbattery1']"}, #  Potencia de/a baterias
'Wplaca' : {"d_['GOODWE']['ppv']"}, #  Potencia de placas
'Wred' :  {"d_['GOODWE']['pgrid']"},     #  Potencia de/a red
'Wconsumo':  {"d_['GOODWE']['house_consumption']"}, # Consumo

'Temp': {"d_['GOODWE']['temperature']"}  #  Temperatura que se guarda en BD y muestra en reloj Web
...
###### Parametros Bateria ######
################################
AH = 150.           # Capacidad en Ah de la Bateria a C20 (poner 0 para instalaciones sin Bateria)
CP = 1.              # Indice Peukert
EC = 1.              # Eficiencia Carga
vsis = 4.            # Voltaje sistema - 1=12V  2=24V   4=48V
vflotacion = 55.7   # Valor por defecto de flotacion a 25ºC a 12V (no se usa por ahora)
# -----------------------------------------------
...
leer_temp_daly = 1              # 1 = leer la temperaturas ... 0 = NO SE USA 
...
IP_GOODWE = "192.168.88.24"     # IP del goodwe
t_muestra_goodwe = 5
