...
Consumo_sensor = "d_goodwe['Consumo']"   # Vbat * (Iplaca-Ibat), d_hibrido['PACW'].

Temperatura_sensor = "d_goodwe['Temp']"  #  d_ds18b20['Temp0'],d_ds18b20['Temp1'],..... d_snre['Temp0'].....
...
usar_smameter = 0        # 1 para leer datos del meter SMA ..... 0 para no 
