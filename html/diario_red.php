...
$sql = "SELECT Fecha as ___Fecha___,maxVred,minVred,maxWred,minWred,avgWred,maxIplaca,avgIplaca,
                round(Wh_placa/1000,2) as kWh_placa,round(Whp_red/1000,2) as kWhp_red,
                round(Whn_red/1000,2) as kWhn_red,round(Wh_consumo/1000,2) as kWh_con,
