...
$sql = "SELECT UNIX_TIMESTAMP(Tiempo)*1000 as Tiempo,  Wred, Wplaca, Vred, PWM, Vplaca
        FROM datos WHERE Tiempo >= (NOW()- INTERVAL 60 MINUTE)
        ORDER BY Tiempo";
    ...
    function recibirDatosFV() {
      $.ajax({
        ...
        success: function(data) {
            ...
            // Actualizacion reloj Wred
            chart_wred.series[0].setData([Wred]);  // Wred
            ...
            //grafica_t_real.series[3].addPoint([x, data[0][6]], true, true); //Aux1
