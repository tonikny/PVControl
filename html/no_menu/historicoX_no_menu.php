	...
	$.ajax({
		...
		success: function (data) {
			try {
				...
				let fecha_time = new Date(fecha.replace(' ', 'T'));
                
				// Obtener la marca de tiempo en milisegundos
				let x = fecha_time.getTime(); 
                                
				// Agregar el nuevo punto al gráfico en la primera serie
                grafica.series[0].addPoint([x, data['FV']['Ibat']], true, true); 
                grafica.series[1].addPoint([x, data['FV']['Iplaca']], true, true); 
                grafica.series[2].addPoint([x, data['FV']['Vbat']], true, true); 
				grafica.series[3].addPoint([x, data['FV']['SOC']], true, true); 
                grafica.series[4].addPoint([x, data['FV']['PWM']], true, true); 
				grafica.series[5].addPoint([x, data['FV']['Vplaca']], true, true);  
                grafica.series[6].addPoint([x, data['FV']['Wplaca']], true, true); 
                grafica.series[7].addPoint([x, data['FV']['Wred']], true, true); 				
                grafica.series[8].addPoint([x, data['FV']['Wconsumo']], true, true); 
                grafica.series[9].addPoint([x, data['FV']['Vred']], true, true); 
				
				let Kwh_placa = data['FV']['Wh_placa'] / 1000;                
				grafica.series[10].addPoint([x, Kwh_placa], true, true);
				
                let Kwh_bat = (data['FV']['Whp_bat'] - data['FV']['Whn_bat']) / 1000;
                grafica.series[11].addPoint([x, Kwh_bat], true, true);

                let Kwh_red = (data['FV']['Whp_red'] - data['FV']['Whn_red']) / 1000;
				grafica.series[12].addPoint([x, Kwh_red], true, true);
				
				grafica.series[13].addPoint([x, data['FV']['Wh_consumo']/1000], true, true);

				
				grafica.series[14].addPoint([x, data['FV']['Temp']], true, true); 
				grafica.series[15].addPoint([x, data['FV']['Modo']], true, true); 
				grafica.series[16].addPoint([x, data['FV']['Aux1']], true, true); 
				grafica.series[17].addPoint([x, data['FV']['Aux2']], true, true); 
			}
...
let t_refresco = <?php echo $t_refresco; ?>;
if (t_refresco > 0) {recibirDatosFV();}
