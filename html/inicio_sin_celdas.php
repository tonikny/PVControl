...
<div id="container_reles" style="width: 100%; height: 160px;"></div>
<div id="grafica_t_real" style="width: 100%; height: 280px;"></div>
            ...
            success: function (data) {
                try {
                    ...
                    for (var i in data['RELES']) {
                        n = data['RELES'][i]['nombre'] + '</br>' + data['RELES'][i]['modo'] +
                            '-P' + data['RELES'][i]['prioridad'] + '-' + data['RELES'][i]['potencia'] +
                            'w-' + data['RELES'][i]['retardo'] + 'sg(' + data['RELES'][i]['espera'] + ')';
