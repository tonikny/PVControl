 ...
 foreach ($dataC as $clave => $valor) {
    ...
    chart_bms_".$clave." = new Highcharts.Chart({
      ...
      series: [
        {
          name: 'Vcelda_max',
          color: Color_valores_max[".$ng."], //rgba(243,41,45,1)',
        ...
        },
        {
          name: 'Vcelda',
          colorByPoint: false,//Color aleatorio para cada columna de un rele
          color: Color_valores[".$ng."], //'rgba(43,132,221,1)',
          opacity: 0.9,
          pointPadding: 0.1,
          pointPlacement: 0,
          borderColor: '#303030',
        ...
        {
          name: 'Vcelda_min',
          color: Color_valores_min[".$ng."], //rgba(243,240,41,1)',
          pointPadding: 0.4,
          pointPlacement: 0.3,
          colorByPoint: false,//Color aleatorio para cada columna de un rele
          borderColor: '#303030',
    ...
    $.ajax({
      ...
      success: function (data) {
        try {
          ...
          ee = 'Capturando datos desde datos_fv.php';
          ...
          ee = 'Actualizacion reloj Ibat/Iplaca';
          ...
          // Actualizacion SOC  
          ee = 'Actualizacion reloj SOC';
          if (SOC >= 98) { color = '#18F905'; }
          else if (SOC > (SOC_min + 20)) { color = 'silver'; }
          ...
          ee = 'Actualizacion reloj Temperaturas';
          ...
          ee = 'Actualizacion reloj Comsumo';
          if (Wconsumo <= Consumo_watios_amarillo) { color = '#18F905'; }
          else if (Wconsumo < Consumo_watios_rojo) { color = 'orange'; }
          else { color = 'red'; };
          ...
          ee = 'Actualizacion Grafica a tiempo real';
          ...
          //Valores de la tabla
          ee = 'Actualizacion Tabla de valores';
          ...
          for (var key in data['BMS']){
             ...
             cc.setSubtitle({
             text: data['BMS'][key]['tiempo'] + ' --- Sum_Celdas=' + sum_celda + 'V -- Max-Min=' + dif_celda + 'mV -- Vbat-Sum_Celdas=' + dif_vbat_celda + 'mV'
             });
             ...
             cc.series[2].setData(data['BMS'][key]['Min']);
			       ...
			       for(i = 0; i < nceldas; i++) {cc.series[1].data[i].update({color: Color_valores[ng-1]}, false)};
			       cc.series[1].data[max_id].update({color: Color_celda_alta[ng-1]}, false);
			       cc.series[1].data[min_id].update({color: Color_celda_baja[ng-1]}, false);
