  ...
  filas: {
    fila1: {
      Placa1: {
        ...
        avisos: {
          1: { color: 'red', condicion: 'd_["FV"]["Wplaca"] < 5 ' },
          2: { color: 'yellow', condicion: '(d_["FV"]["Wplaca"]) < 300' },
          3: {
            color: 'cyan',
            condicion:
              'new Date(d_["FV"]["tiempo"]) < new Date(now.getTime() - 1 * 60 * 1000)',
          }, //1 minuto
        },
        elements: {
          Solar1: {
      ...
      Casa1: {
        ...
        elements: {
          Wconsumo: {
            ...
            backgroundColor: '',
            bold: true,
            position: { x: -34, y: 20 }, //width: 70,
            showTitle: false,
          },

          Wh_consumo: {
            campoBD: 'FV.Wh_consumo',
            value: 0,
            unit: 'Wh',
            size: '16px',
            titleColor: 'black',
