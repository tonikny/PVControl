    ...
    filas: {
        ...
        fila3: {
            ...
            ANENJI1: {
                ...
                elements: {
                    ...
                    Ibat: { campoBD: 'ANENJI1.Ibat', value: 0, unit: "A", size: "16px", titleColor: 'black',  valueColor: 'blue', backgroundColor: '',bold: true, position: { x: 82, y: 29 }, width: 70,
                    showTitle: false  },
            ...
            ANENJI2: {
                ...
                elements: {
                    ...
                    Ibat: { campoBD: 'ANENJI2.Ibat', value: 0, unit: "A", size: "16px", titleColor: 'black',  valueColor: 'blue', backgroundColor: '',bold: true, position: { x: -48, y: 29 }, width: 70,
                    showTitle: false  },
        ...
        fila4:{
            R551_Termo2: {
                image: 'termo_agua.jpg',
                size: { width: 53, height: 80 },
                connectTo: { id: 'ANENJI1', from: 'top',  to: 'left', control: 'Wconsumo', max: 2000, min: 10, colorLineaPositiva:'red',flujoLinea:'inverso',},
            ...
            R551_Termo3: {
                image: 'termo_agua.jpg',
                size: { width: 53, height: 80 },
                connectTo: { id: 'ANENJI2', from: 'top',  to: 'botton', control: 'Wconsumo', max: 2000, min: 10, colorLineaPositiva:'red',flujoLinea:'inverso',},
        ...
        fila5: {
            JK1: {
                ...
                size: { width: 100, height: 100 },
                avisos: {
                    KO: {color:'red', condicion:'new Date(d_["BMS_JK1"]["tiempo"]) < new Date(now.getTime() - 0.01 * 60 * 1000)'},
                },
                connectTo: {id: 'BATERIA', from: 'top', to: 'bottom', control: 'Ibat',
                            max: 50, min: 0, flujoLinea:'inverso', colorLineaPositiva:'green', },
                elements: {
                    Banco1: {
                        campoBD: '',
                        value: 'JK1',
