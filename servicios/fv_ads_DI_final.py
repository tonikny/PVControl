...
log_local.info(Style.BRIGHT + Fore.YELLOW + 'Arrancando' + Fore.GREEN + ' fv_ads_DI_final.py')
...
parametros = GestorParametrosDI().leer_parametros("usar_ADS", "nombre_ADS", "direccion_ADS", "var_ADS", 
...
if __name__ == '__main__':
    ...
    while True:
        try:
            ...
            print()
            print(Fore.RED + '=' * 50)
            print ('Finalizando fv_ads_DI_final.py.......')
            for p in Procesos:
