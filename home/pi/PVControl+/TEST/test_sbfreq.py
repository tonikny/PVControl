    ...
    while True:
        ...
        #leemos frecuencia
            if simulacion == 0:
                ...
                valor = random.choice([50.0,50.2,50.7,50.9,51.2,51.4,51.6])
...
# --------------------
        print (freq) # aqui tenemos la lista con las 5 últimas frecuencias
        ...
        print ('EINT:', round(EINT,2),'EP:', round(EP,2),'INCPWM:', round(INCPWM,2),'PWM:', int(PWM))
